  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 flex flex-col items-center text-center min-h-[calc(100vh-80px)] justify-center">
      <div className="relative mb-8 animate-fade-in">
        <Image
          src="https://firestuff.storage.googleapis.com/user/studio_content/images/images/4140a680-378c-4656-a982-6ca116a5a530"
          alt="DeepTerrorGG Avatar - Dark warrior with glowing eyes"
          width={160}
          height={160}
          className="rounded-full border-4 border-primary shadow-xl object-cover"
          data-ai-hint="dark warrior"
          priority
        />
        <Brush className="absolute bottom-0 right-0 h-10 w-10 p-2 bg-primary text-primary-foreground rounded-full shadow-lg transform translate-x-1/4 translate-y-1/4 border-2 border-background" />
      </div>
      
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-foreground mb-6 animate-slide-up" style={{ animationDelay: '0.2s' }}>
        Welcome to <span className="text-primary">DeepTerrorGG</span>'s Portfolio
      </h1>
      
      <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: '0.4s' }}>
