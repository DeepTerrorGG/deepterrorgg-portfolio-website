...
const Loader = () => <div className="flex h-full min-h-[200px] w-full items-center justify-center"><Loader2 className="h-8 w-8 animate-spin text-primary" /></div>;

const TodoList = dynamic(() => import('@/components/projects/todo-list'), { loading: Loader });
const UnitConverter = dynamic(() => import('@/components/projects/unit-converter'), { loading: Loader });
const Calculator3D = dynamic(() => import('@/components/projects/calculator-3d'), { loading: Loader });
const SimpleTextAnimator = dynamic(() => import('@/components/projects/simple-text-animator'), { loading: Loader });
const FractalRenderer = dynamic(() => import('@/components/projects/fractal-renderer'), { loading: Loader });
const PomodoroTimer = dynamic(() => import('@/components/projects/pomodoro-timer'), { loading: Loader });
const PasswordGenerator = dynamic(() => import('@/components/projects/password-generator'), { loading: Loader });
const BmiCalculator = dynamic(() => import('@/components/projects/bmi-calculator'), { loading: Loader });
const BudgetPlanner = dynamic(() => import('@/components/projects/budget-planner'), { loading: Loader });
const GithubProfileFinder = dynamic(() => import('@/components/projects/github-profile-finder'), { loading: Loader });
const BeatMaker = dynamic(() => import('@/components/projects/beat-maker'), { loading: Loader });
const MarkdownEditor = dynamic(() => import('@/components/projects/markdown-editor'), { loading: Loader });
const WeatherApp = dynamic(() => import('@/components/projects/weather-app'), { loading: Loader });
const StockTracker = dynamic(() => import('@/components/projects/stock-tracker'), { loading: Loader });
const Spreadsheet = dynamic(() => import('@/components/projects/spreadsheet'), { loading: Loader });
const TicTacToe = dynamic(() => import('@/components/projects/tic-tac-toe'), { loading: Loader });
const RockPaperScissors = dynamic(() => import('@/components/projects/rock-paper-scissors'), { loading: Loader });
const CharacterCounter = dynamic(() => import('@/components/projects/character-counter'), { loading: Loader });
const CollaborativeWhiteboard = dynamic(() => import('@/components/projects/collaborative-whiteboard'), { loading: Loader });
const PixelEditor = dynamic(() => import('@/components/projects/pixel-editor'), { loading: Loader });
const TurnBasedStrategy = dynamic(() => import('@/components/projects/turn-based-strategy'), { loading: Loader });
const DeckBuildingRoguelike = dynamic(() => import('@/components/projects/deck-building-roguelike'), { loading: Loader });
const IdleClickerGame = dynamic(() => import('@/components/projects/idle-clicker-game'), { loading: Loader });
const DoomEmulator = dynamic(() => import('@/components/projects/doom-emulator'), { loading: Loader });
const DownDetectorDetector = dynamic(() => import('@/components/projects/down-detector-detector'), { loading: Loader });
const UselessUiPlayground = dynamic(() => import('@/components/projects/useless-ui-playground'), { loading: Loader });
const ScreenshotService = dynamic(() => import('@/components/projects/screenshot-service'), { loading: Loader });
const WebsiteStatusChecker = dynamic(() => import('@/components/projects/website-status-checker'), { loading: Loader });
const SortingVisualizer = dynamic(() => import('@/components/projects/sorting-visualizer'), { loading: Loader });
const EcommerceDashboard = dynamic(() => import('@/app/dashboard/page'), { loading: Loader });
const InventoryDashboard = dynamic(() => import('@/components/projects/inventory-dashboard/inventory-dashboard'), { loading: Loader });
const SpotifyPlaylistGenerator = dynamic(() => import('@/components/projects/spotify-playlist-generator'), { loading: Loader });
const SpeedTester = dynamic(() => import('@/components/projects/speed-tester'), { loading: Loader });
const PathfindingVisualizer = dynamic(() => import('@/components/projects/pathfinding-visualizer'), { loading: Loader });
const AsciiWebcam = dynamic(() => import('@/components/projects/ascii-webcam'), { loading: Loader });
const CodeRacer = dynamic(() => import('@/components/projects/code-racer'), { loading: Loader });
const TimeCapsuleProject = dynamic(() => import('@/components/projects/time-capsule'), { loading: Loader });
const InfiniteCanvas = dynamic(() => import('@/components/projects/infinite-canvas'), { loading: Loader });
const GitHistoryVisualizer = dynamic(() => import('@/components/projects/githistory-visualizer'), { loading: Loader });
const VoiceControlledTetris = dynamic(() => import('@/components/projects/voice-controlled-tetris'), { loading: Loader });
const FractalTree = dynamic(() => import('@/components/projects/fractal-tree'), { loading: Loader });
const BinaryVsLinearSearch = dynamic(() => import('@/components/projects/binary-vs-linear-search'), { loading: Loader });
const SudokuSolver = dynamic(() => import('@/components/projects/sudoku-solver'), { loading: Loader });
const ConnectFour = dynamic(() => import('@/components/projects/connect-four'), { loading: Loader });
const MemoryMatrix = dynamic(() => import('@/components/projects/memory-matrix'), { loading: Loader });
const BookingCalendar = dynamic(() => import('@/components/projects/booking-calendar'), { loading: Loader });
const ThisDayInHistory = dynamic(() => import('@/components/projects/this-day-in-history'), { loading: Loader });
const DigitalAssetManager = dynamic(() => import('@/components/projects/digital-asset-manager'), { loading: Loader });
const PaymentLedger = dynamic(() => import('@/components/projects/payment-ledger'), { loading: Loader });
const LogIngestor = dynamic(() => import('@/components/projects/log-ingestor'), { loading: Loader });
const HeadlessCms = dynamic(() => import('@/components/projects/headless-cms'), { loading: Loader });
const DistributedFractalExplorer = dynamic(() => import('@/components/projects/distributed-fractal-explorer'), { loading: Loader });
