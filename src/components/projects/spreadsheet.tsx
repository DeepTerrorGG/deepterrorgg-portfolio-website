...
import { Table, Plus, X, Save, FolderOpen, Monitor } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center w-full h-full bg-card p-4">
      ...
      <div className="md:hidden fixed inset-0 z-[100] bg-[#0A0A0A] flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-muted-foreground max-w-md text-sm leading-relaxed">
          The Web-Based Spreadsheet contains dense data grids and complex controls that are fully optimized for larger screens. Please visit this page on your desktop or laptop.
        </p>
      </div>
